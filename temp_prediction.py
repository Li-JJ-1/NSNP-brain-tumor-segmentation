...
from networks.MPEDANet.MPEDANet import MPEDANet
...
def main(args):
    ...
    # data info
    data_path = "./datasets/BraTS2021/BraTS2021_dataset"
    test_txt = "./datasets/BraTS2021/train.txt"
    ...
    # data_path = "../datasets/brats2018/data"
    # patch_size = (128, 128, 64)
    ...
    elif MODEL_NAME == 'MPEDANet':
        model = MPEDANet(in_channels=4, num_classes=4).to(device)
    ...
    model.eval()
    # (90,30) (36,14) (28,40) (45,27) (50,43)-- train
    d1 = test_set[90]
    slice_w = 30
    image, label = d1
